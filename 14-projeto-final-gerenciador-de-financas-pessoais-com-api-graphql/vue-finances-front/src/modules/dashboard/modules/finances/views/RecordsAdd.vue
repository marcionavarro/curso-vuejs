      ...
      <v-flex xs12 sm6 md8 lg8>
        <v-card>
          <v-card-text>
            ...
            <v-text-field name="description" label="Descrição" prepend-icon="description" type="text"></v-text-field>
            <v-text-field name="tags" label="Tags (separadas por virgula)" prepend-icon="label"
              type="text"></v-text-field>
            <v-text-field name="note" label="Observação" prepend-icon="note" type="text"></v-text-field>
          </v-card-text>
        </v-card>
      </v-flex>
    </v-layout>
