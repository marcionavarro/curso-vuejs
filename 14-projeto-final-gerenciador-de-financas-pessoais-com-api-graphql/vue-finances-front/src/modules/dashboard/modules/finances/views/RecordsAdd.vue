      ...
      <v-flex xs12 sm6 md8 lg8>
        <v-card>
          <v-card-text>
            ...
            <v-tooltip left>
              <template v-slot:activator="{ on }">
                <v-btn icon small class="mr-3" v-on="on"><v-icon :color="color"
                    @click="showTagsInput = !showTagsInput">label</v-icon></v-btn>
              </template>
            ...
            <v-tooltip right>
              <template v-slot:activator="{ on }">
                <v-btn icon small v-on="on"><v-icon :color="color"
                    @click="showNoteInput = !showNoteInput">note</v-icon></v-btn>
              </template>
        ...
        <v-btn color="secondary" large fab class="mt-4 mr-5" @click="$router.back()">
          <v-icon>close</v-icon>
        </v-btn>
